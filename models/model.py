...
class Transformer(nn.Module):
    def __init__(self, num_tokens, dim, depth, heads, dim_head, attn_dropout, ff_dropout):
        ...
        for _ in range(depth):
            self.layers.append(nn.ModuleList([
                PreNorm(dim, Residual(Attention(dim, heads = heads, dim_head = dim_head, dropout = attn_dropout))),     # Attention -> Normalization
                PreNorm(dim, Residual(FeedForward(dim, dropout = ff_dropout))),     # Feedforward -> Normalization
            ]))
